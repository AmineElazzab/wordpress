  ...
  <div class="yay-smtp-card-body">
    <div class="setting-el">
      ...
      <div class="setting-field">
        <input type="text" data-setting="api_key" id="yay_smtp_setting_sendpulse_api_key" class="yay-settings" value="<?php echo $apiKey ?>">
    ...
    <div class="setting-el">
      ...
      <div class="setting-field">
        <input data-setting="secret_key" type="password" spellcheck="false" id="yay_smtp_setting_sendpulse_secret_key" class="yay-settings" value="<?php echo $secretKey ?>">
        <p class="setting-description">
          Click here to
