...
use YaySMTP\Aws3\Aws\Crypto\Cipher\CipherMethod;
use YaySMTP\Aws3\Aws\Crypto\Cipher\Cbc;
...
abstract class AbstractCryptoClient
{
     ...
     * @internal
     */
    public abstract function encrypt(\YaySMTP\Aws3\GuzzleHttp\Psr7\Stream $plaintext, array $cipherOptions, \YaySMTP\Aws3\Aws\Crypto\MaterialsProvider $provider, \YaySMTP\Aws3\Aws\Crypto\MetadataEnvelope $envelope);
    /**
     ...
     * @internal
     */
    public abstract function decrypt($cipherText, \YaySMTP\Aws3\Aws\Crypto\MaterialsProvider $provider, \YaySMTP\Aws3\Aws\Crypto\MetadataEnvelope $envelope, array $cipherOptions = []);
}
