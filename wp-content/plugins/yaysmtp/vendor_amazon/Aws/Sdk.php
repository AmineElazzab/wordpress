...
class Sdk
{
    ...
    public function createClient($name, array $args = [])
    {
        ...
        $client = "YaySMTP\\Aws3\\Aws\\{$namespace}\\{$namespace}Client";
    ...
    public function createMultiRegionClient($name, array $args = [])
    {
        ...
        $service = manifest($name);
        $namespace = $service['namespace'];
        $klass = "YaySMTP\\Aws3\\Aws\\{$namespace}\\{$namespace}MultiRegionClient";
        $klass = class_exists($klass) ? $klass : 'YaySMTP\\Aws3\\Aws\\MultiRegionClient';
