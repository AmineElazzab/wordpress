 ...
 */
class AppendStream implements \YaySMTP\Aws3\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\YaySMTP\Aws3\Psr\Http\Message\StreamInterface $stream)
    {
