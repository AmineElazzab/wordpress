 ...
 */
class MultipartStream implements \YaySMTP\Aws3\Psr\Http\Message\StreamInterface
{
    ...
    {
        $stream = new \YaySMTP\Aws3\GuzzleHttp\Psr7\AppendStream();
    ...
    private function addElement(\YaySMTP\Aws3\GuzzleHttp\Psr7\AppendStream $stream, array $element)
    {
     ...
     * @return array
     */
    private function createElement($name, \YaySMTP\Aws3\Psr\Http\Message\StreamInterface $stream, $filename, array $headers)
    {
